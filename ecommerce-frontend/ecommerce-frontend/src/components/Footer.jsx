        ...
        <div className="row mb-5">
          <div className="col-md">
            <div className="ftco-footer-widget mb-4">
              <h2 className="ftco-heading-2"><Link to="#" className="logo">SOS<span>cars</span></Link></h2>
            ...
            <div className="ftco-footer-widget mb-4">
            	...
            	<div className="block-23 mb-3">
	              <ul>
	                ...
	                <li><Link to="#"><span className="icon icon-phone"></span><span className="text">+91 8788721430</span></Link></li>
	                <li><Link to="#"><span className="icon icon-envelope"></span><span className="text">carrental@sos.com</span></Link></li>
	              </ul>
	            </div>
            </div>
          </div>
