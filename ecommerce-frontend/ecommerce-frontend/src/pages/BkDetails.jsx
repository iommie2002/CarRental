...
export default function BkDetails() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    setfdata({ ...fdata,['amount']: data?.billamount - data?.advance })
              ...
              <div className='card-body'>
                ...
                <table className='table table-sm'>
                  <tbody>
                    ...
                    <tr>
                      <th>Price per Day</th>
                      <th>{INDCurrency.format(data?.variant?.price).replace("ANG","Dh")} / day</th>
                    </tr>
                    <tr>
                      <th>Bill Amount</th>
                      <th>{INDCurrency.format(data?.billamount).replace("ANG","Dh")}</th>
                    </tr>
                    <tr>
                      <th>Advance Paid </th>
                      <th>{INDCurrency.format(data?.advance).replace("ANG","Dh")}</th>
                    </tr>
                  </tbody>
                </table>
              </div>
